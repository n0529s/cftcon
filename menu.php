...
<div style="display: flex; justify-content:space-between; width:400px">
  ...
  <input style="coler:white; border-color:#3b82f6;color:white; font-size:18px;margin-right:30px;padding:10px 20px; background:#8EA9DB; border-radius:10px;" type="submit" value="施工管理" />
  </form>
</div>
